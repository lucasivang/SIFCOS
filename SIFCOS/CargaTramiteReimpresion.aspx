<%@ Page Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true"
	CodeBehind="CargaTramiteReimpresion.aspx.cs" Inherits="SIFCOS.CargaTramiteReimpresion"
...
<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeaderContent">
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li><a href="ReimpresionOblea.aspx">Reimpresión de oblea/certificado</a> <i class="fa fa-angle-right">
			</i></li>
			<li><a href="CargaTramiteReimpresion.aspx">Carga Trámite de Reimpresión</a> <i class="fa fa-angle-right">
			</i></li>
		</ul>
	</div>
</asp:Content>
									...
									<div class="portlet-body">
										<div class="scroller" style="height: 300px">
											...
											<h3 class="form-section">
												Domicilio del Establecimiento</h3>
											<div class="row">
											...
											<h3 class="form-section">
												Contacto del Establecimiento</h3>
											<div class="row">
												<div class="col-md-2 labelPrimario">
													<label>
														Email :</label>
											...
											<h3 class="form-section">
												Productos, Actividad Primaria y Secundaria</h3>
											<br />
											<div class="row">
												<div class="col-md-4 labelPrimario">
													<label>
								...
								<div class="dashboard-stat blue-madison">
									...
									<div class="details">
										...
										<div class="desc" style="margin-top: 4px;">
											...
											<asp:TextBox ID="TextBox1" runat="server" placeholder="Ingrese nro SIFCoS..." disable="true"
						...
						<div class="form-body">
							<ul class="nav nav-pills nav-justified steps">
								<li id="li_tab_1" runat="server" class=""><a class="step"><span class="number">1 </span>
									<span class="desc"><i class="fa fa-check"></i>INICIO</span></a> </li>
							...
							<div id="divPanel_1" runat="server" class="tab-pane active">
								...
								<div runat="server" id="DivAdjuntar" visible="True">
									<div class="row">
										<div class="col-md-12">
											<div class="alert alert-block alert-info fade in">
												...
												<ul>
													<li>ESCANEE PREVIAMENTE LA DENUNCIA POR EXTRAVIO EN FORMATO PDF O, EN SU DEFECTO, ADJUNTE
														FOTO DE LA OBLEA/CERTIFICADO DETERIORADA/O
														<%--<br />
														ESTOS DOCUMENTOS SON OBLIGATORIOS PARA FINALIZAR EL TRAMITE DE REIMPRESION DE OBLEA/CERTIFICADO<br />
														PARA CONTROL DE LA INFORMACION REGISTRADA.--%>
													</li>
												</ul>
											</div>
										</div>
									</div>
									<%--BOCA DE RECEPCION DEL TRAMITE--%>
									<div runat="server" id="Div1" visible="True">
										<div class="row">
											<div class="col-md-12">
												<div class="form-section">
													<h5>Seleccionar
														<strong>Boca de Recepción</strong></h5>
												</div>
												<div>
													<asp:DropDownList ID="ddlMyBoca" runat="server">
													</asp:DropDownList>
												</div>
											</div>
										</div>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-section">
												<h5>
													Adjuntar <strong>Foto de oblea/certificado deteriorado</strong></h5>
											</div>
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div>
													<asp:FileUpload ID="documento2" ClientIDMode="Predictable" AllowMultiple="false"
														accept="images/*" runat="server" />
												</div>
											</div>
										</div>
									</div>
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-section">
												<h5>
													Adjuntar <strong>Denuncia por extravío</strong></h5>
											</div>
											<div class="fileinput fileinput-new" data-provides="fileinput">
												<div>
								...
								<%--<h3 class="form-section">
                                    Ubique su Establecimiento en el Mapa
                                </h3>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label>
                                                    Ingrese la dirección de su Establecimiento :</label>
                                                <input id="_txtDireccion" class="form-control" type="text" name="name" value="" />
                                                <span class="help-block">Escriba la dirección de su establecimiento y seleccione la
                                                    dirección que brinda Google Maps. Luego de seleecionar la dirección puede corregir
                                                    su ubcación arrastrando el marcador.</span>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div id="divMapa" style="width: 100%; height: 400px;">
                                            --MAPA SIFCoS--
                                        </div>
                                    </div>
                                </div>--%>
							</div>
							<%--segundo paso carga de domicilios y contacto--%>
							<div id="divPanel_2" runat="server" class="tab-pane">
								...
								<%--<asp:UpdatePanel ID="UpdatePanel1" runat="server">
									<ContentTemplate>
										<div class="portlet box yellow" id="form_wizard_DM">
											<div class="portlet-title">
												<div class="caption">
													<span id="lblDomLegalYEstab">II - DOMICILIOS LEGAL Y DEL ESTABLECIMIENTO</span>
												</div>
											</div>
											<div class="portlet-body form">
												<div class="form-wizard">
																...
																<div class="row">
																	<div class="col-md-12">
																		<ul class="nav nav-tabs">
																			<li class="active"><a href="#tab_dom_real" data-toggle="tab" class="font-blue-steel font-lg bold uppercase">
																				DOMICILIO COMERCIO </a></li>
																			<li class=""><a href="#tab_dom_legal" data-toggle="tab" class="font-blue-steel font-lg bold uppercase">
																				DOMICILIO LEGAL </a></li>
																		</ul>
																		<div class="tab-content">
																			<div class="tab-pane fade active in" id="tab_dom_real">
																				<div class="row">
																					<div class="col-md-12">
																						<iframe class="tamañoIframe" id="VIN_DOM_REAL" src="<%= UrlDomComercio %>" style="min-height: 800px;
																							width: 100%;"></iframe>
																					</div>
																				</div>
																				<div class="row">
																					<div class="col-md-3">
																						<asp:Button runat="server" ID="btnModificarDomEstab" CssClass="btn blue" Style="margin-bottom: 10px;
																							margin-top: 10px;" Text="MODIFICAR DOMICILIO ESTABLECIMIENTO" OnClick="btnModificarDomComercio_OnClick" />
																					</div>
																				</div>
																			</div>
																			<div class="tab-pane fade " id="tab_dom_legal">
																				<div class="row">
																					<div class="col-md-12">
																						<iframe class="tamañoIframe" id="VIN_DOM_LEGAL" src="<%= UrlDomLegal %>" style="min-height: 800px;
																							width: 100%;"></iframe>
																					</div>
																				</div>
																				<div class="row">
																					<div class="col-md-3">
																						<asp:Button runat="server" ID="btnModificarDomLegal" CssClass="btn blue" Style="margin-bottom: 10px;
																							margin-top: 10px;" Text="MODIFICAR DOMICILIO LEGAL" OnClick="btnModificarDomLegal_OnClick" />
																					</div>
																				</div>
																			</div>
																		</div>
								...
								<h3 class="form-section">
									II - Datos de Contacto del Establecimiento</h3>
								<div class="row">
									<div class="col-md-12">
										<label>
							...
							<%--tercer paso carga de info gral--%>
							<div id="divPanel_3" runat="server" class="tab-pane">
								<h4 class="form-section">
									Productos del Comercio</h4>
								<div class="row">
									<div class="form-group">
										<div class="col-md-12">
											<div class="alert alert-block alert-info fade in">
								...
								<asp:UpdatePanel runat="server" ID="upInformacionGeneral">
									<ContentTemplate>
										...
										<div class="row">
											<div class="form-group">
												<div class="col-md-5">
													<asp:TextBox ID="txtBuscarProducto" runat="server" AutoPostBack="True" Width="100%"
														OnTextChanged="txtBuscarProducto_TextChanged" placeholder="  Ingrese El Producto / Servicio de su comercio">
													</asp:TextBox>
													<Ajx:AutoCompleteExtender ServiceMethod="BuscarProducto" CompletionInterval="100"
												...
												<div class="col-md-3">
													<asp:Button class="btn btnAgregarProductoALista  btn-circle" ID="btnAgregarProd"
														Text="+ Agregar Producto a la Lista" runat="server" OnClick="btnAgregarProd_Click">
													</asp:Button>
												</div>
												<div class="col-md-4">
													<div class="row">
										...
										<br />
										<h4 class="form-section">
											Actividad Primaria y Secundaria del Comercio</h4>
										<div class="row">
											<div class="col-md-12">
												<div class="alert alert-block alert-info fade in">
													<label>
								...
								<div class="row">
									<div class="col-md-4">
										<label>
											Fecha de Inicio de Actividad :(*)</label>
										<div class="textBoxFecha">
											<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
											<asp:TextBox ID="txtFechaIniAct" CssClass="form-control" runat="server"></asp:TextBox>
											<span id="spanFechaInicioAct" class="help-block" style="color: red;">El formato de la
												fecha es Inválido.</span>
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-group">
									...
									<div class="col-md-4">
										<div class="form-group">
											...
											<Ajax:FilteredTextBoxExtender ID="FilteredTextBoxExtender1" runat="server" Enabled="True"
												FilterType="Numbers" TargetControlID="txtSupAlquiler">
											</Ajax:FilteredTextBoxExtender>
										</div>
									</div>
									<div class="col-md-12">
										<div class="form-group">
											...
											<br />
											<asp:RadioButton ID="rb5" Text="MENOR A $ 50.000" CssClass="CorregirFocoRadioButton"
												GroupName="RangoAlquiler" runat="server" />
											<asp:RadioButton ID="rb510" Text="$ 50.000 a $ 100.000" CssClass="CorregirFocoRadioButton"
												GroupName="RangoAlquiler" runat="server" />
											<asp:RadioButton ID="rb1015" Text="$ 100.000 a $ 150.000" CssClass="CorregirFocoRadioButton"
												GroupName="RangoAlquiler" runat="server" />
											<asp:RadioButton ID="rb1520" Text="Más de $ 150.000" CssClass="CorregirFocoRadioButton"
												GroupName="RangoAlquiler" runat="server" />
										</div>
									</div>
								</div>
							...
							<%--cuarto paso carga de representante legal y gestor y aceptacion de declaracion jurada--%>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<asp:Button runat="server" ID="btnAtras" CssClass="btn botonAtras btn-circle form-control"
								Text="Atrás" OnClick="btnAtras_OnClick" /></div>
						<div class="col-md-3">
