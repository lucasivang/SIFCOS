...
//        }); //direct mask        
        ...
        $(".mascaraFecha").inputmask("d/m/y", {
            "placeholder": "*"
        }); //change the placeholder
        
        $("#ConenedorPrincipal_txtFechaIniAct").inputmask("d/m/y", {
            "placeholder": "*"
        }); //change the placeholder
        
        $("#ConenedorPrincipal_txtFechaExpPol").inputmask("d/m/y", {
            "placeholder": "*"
        });//change the placeholder
...
//        }); //specifying fn & options
        ...
        $(".MascaraCuit2").inputmask({
            "mask": "99999999999",
            placeholder: "" // remove underscores from the input mask
        }); //specifying options only
        
        $(".MascaraNumeroEntero").inputmask({
            "mask": "9",
            "repeat": 10,
            "greedy": false
       ...
       $(".MascaraEmail").inputmask({
            mask: "*{1,20}[.*{1,20}][.*{1,20}][.*{1,20}]@*{1,20}.*{2,6}[.*{1,2}]",
            greedy: false
        }); 
        
        $(".MascaraURL").inputmask('url', {
            autoUnmask: false
        }); 
