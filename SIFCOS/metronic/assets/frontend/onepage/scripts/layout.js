var Layout = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#id_style_color').attr("href", "metronic/assets/frontend/onepage/css/themes/" + color + ".css");
            $('.site-logo img').attr("src", "metronic/assets/frontend/onepage/img/logo/" + color + ".png");
        }
