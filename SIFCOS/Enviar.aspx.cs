        ...
        public async Task EnviarNotificacionAsync(string token,string destinatario)
        {
            ...
            var datos = new
            {
                ...
                Contenido = "Desde la Secretaría de Comercio, dependiente del Ministerio de Producción,Ciencia e Innovación Tecnológica del <br />" +
                            ...
                            "<b><u> NO SE ENCUENTRA REGULARIZADA </u> su situación en el Registro de Comercio </b >, todo ello en virtud de que la Ley <br />" +
                            "Provincial N° 9.693 y su Decreto Reglamentario N°: 1016 / 2010, <u> ORDENA </u> a todas las unidades económicas en cuyo<br />" +
                            "ámbito se realicen actos de comercio o de servicios, ya sean de existencia visible o ideal, sociedades de cualquier<br />" +
                            "tipo, minoristas o mayoristas, nacionales o extranjeras, cuya actividad principal sea la venta directa al público <br />" +
                            "con carácter habitual en la provincia de Córdoba, en locales individuales o en espacios colectivos, a: <br />" +
                            "<b> Inscribirse y / o Reempadronarse </b>, en el Registro Comercial del Sistema de Información para el Fortalecimiento <br />" +
                            "de La Actividad Comercio y los Servicios -SIFCoS. <br/>" +
                            "Es por ello que lo INVITAMOS a regularizar su situación lo antes posible, evitando así incurrir en infracción. <br />" +
                            "Ud.podrá corroborar su situación ingresando a sitio WEB oficial del Gobierno de la Provincia de Córdoba <br />" +
                            "con su Ciudadano Digital Nivel 2 <br /><b><a href=https://sifcos.cba.gov.ar>Ir a Sifcos</a></b><br /><br />" +
            ...
            using (var client = new HttpClient())
            {
                ...
                String MisTramites=(String)Session["MisTramites"];
                ...
                if (!String.IsNullOrEmpty(MisTramites))
                {
                    Session["MisTramites"] = null;
