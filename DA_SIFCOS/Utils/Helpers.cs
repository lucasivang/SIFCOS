...
namespace DA_SIFCOS.Utils
{
    public class Helpers
    {
        ...
        public bool Is_Valid_Key_Lenght(byte[] pByteArrayKey)
        {
            bool retOk = true;

            if (pByteArrayKey.Length != pByteArrayKey.Length)
                retOk = false;
        ...
        //public Size LockAspectRatio(string sFilePath, double maxWidth, double maxHeight)
        //{
        ...
        //    {
        //        pImagen.Save(stream, ImageFormat.Png);
        //        stream.Close();
        ...
        public String Get_Version()
        {
            ...
            return "Versión " + _fvi.FileVersion;
        }
        ...
        /// <summary>
        /// Metodo utilizado para obtener el TOKEN necesario para utilizar las notificaciones CIDI
        /// </summary>
        /// <returns></returns>
